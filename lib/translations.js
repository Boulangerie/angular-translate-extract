 ...
 * @private
 */
var __isValidTranslation = function __isValidTranslation(key) {
...
Translations.prototype.getMergedTranslations = function (obj, useDefault) {
  ...
  if (this.params.safeMode) {
    ...
    _.forEach(translations, function (v, k) {
      if (__isValidTranslation(obj[k])) {
        // Get from old translations
        returnTranslations[k] = obj[k];
      } else if (__isValidTranslation(v)) {
 ...
 * @returns {Object}
 */
Translations.prototype.getStats = function () {
  return this._stats;
};
/**
